						...
						<div className="lg:flex lg:flex-row  grid grid-rows-2 col-span-4   lg:items-center lg:justify-around ab-des-main w-full" >
							...
							<div data-aos="fade-up">
								<Tilt scale={1}>
									...
									<img className="lg:w-64 lg:h-96 lg:rounded-lg lg:absolute lg:bottom-20 lg:right-16 w-40 ml-14  h-52 absolute  bottom-6 rounded-lg" src="https://media-exp1.licdn.com/dms/image/C4D03AQHMAZho0ChEwg/profile-displayphoto-shrink_800_800/0/1654530501224?e=1660176000&v=beta&t=uCSBl8nnlqQATyIWrBwgQZz5D97txvCUDURvGvMYNFg" alt="pics" />
