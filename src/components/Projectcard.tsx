		...
		<div className="proj-main lg:items-center  lg:justify-end  text-sm flex items-center justify-start bg-gray-900 lg:bg-black  " data-aos="fade-up">
			<div className="lg:flex proj-sub-div lg:flex-col lg:justify-center lg:items-end  lg:p-5 lg:gap-4 lg:z-20 flex flex-col  justify-center items-start p-5 gap-4">
				...
				<div className="https://github.com/KrishKashiwala/Farmgistics">
					<p className="lg:absolute lg:w-2/4 lg:rounded-3xl lg:bg-gray-900 lg:right-4 lg:p-5 lg:float-bottom lg:text-right   w-full ">A non-profit company that aims to give farmers their selling rights and reach every part of India. We, also believe in Aatmanirbhar Bharat.</p>
				</div>
				<a href="https://github.com/KrishKashiwala/Farmgistics" rel="noreferrer" target="_blank" className="lg:absolute lg:mt-64 link  transition ease-in-out duration-1000">
