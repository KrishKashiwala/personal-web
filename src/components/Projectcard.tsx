  ...
  return (
    ...
    >
      <div className="lg:flex proj-sub-div lg:flex-col lg:justify-center lg:items-end  lg:p-5 lg:gap-4 lg:z-20 flex flex-col  justify-center items-start p-5 gap-4">
        ...
        <div>
          <p className="lg:absolute lg:w-2/4 lg:rounded-3xl lg:bg-gray-900  lg:right-4 lg:p-5 lg:float-bottom lg:text-right  lg:text-gray-400 projcard">
            {description}
          </p>
        </div>
        <div className="socialLinks">
          {url !== undefined ? (
            <a
              href={url}
              className=" link  transition ease-in-out duration-200 fill-current"
            >
              <svg
                width="24"
                height="24"
