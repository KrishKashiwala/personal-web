...
const Project = ({ title, des, gitlink, extralink }: any) => {
	...
	return (
		<div className="lg:w-80 lg:p-3  lg:flex lg:flex-col pro-main lg:rounded-2xl lg:mt-20 hvr-grow w-80 flex flex-col justify-items-center rounded-2xl justify-center p-3 text-sm">
			...
			<div className="content flex flex-col gap-5 mt-5">
				...
				<h6 className="text-gray-400  flex justify-start">{des}</h6>
			</div>
