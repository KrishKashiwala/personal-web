		...
		<div className="w-80 p-3 overflow-auto flex flex-col  pro-main rounded-2xl mt-20">
			<div className="flex flex-row  justify-between items-center">
				...
				<div className="flex flex-row">
					...
					<a href={extralink} rel="noreferrer" target="_blank" className=" ml-5"><svg className="fill-current text-gray-300" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path d="M21 13v10h-21v-19h12v2h-10v15h17v-8h2zm3-12h-10.988l4.035 4-6.977 7.07 2.828 2.828 6.977-7.07 4.125 4.172v-11z" /></svg></a>
				</div>
			</div>
